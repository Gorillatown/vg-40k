...
/obj/item/clothing/mask/gas/mime/attackby(obj/item/weapon/W, mob/user)
	if(istype(W, /obj/item/toy/crayon))
		...
		switch(maskselect)
			...
			if("Solitare")
				spawn(0)
					if(istype(user.get_active_hand(), /obj/item/clothing/mask/gas/mime))
						user.visible_message("<span class='notice'>[user] draws on the mask with deep shades of purple.</span>", "<span class='notice'>She who thirsts, The great enemy, The unnamed prince. Everyone has a role to play in this dance. Even her.</span>", "<span class='warning>HOLY CRAP WHAT?!</span>")
						qdel(user.get_active_hand())
						user.put_in_hands(new /obj/item/clothing/mask/gas/mime/solitare(user))
					else if(istype(user.get_inactive_hand(), /obj/item/clothing/mask/gas/mime))
						user.visible_message("<span class='notice'>[user] draws on the mask with deep shades of purple.</span>", "<span class='notice'>She who thirsts, The great enemy, The unnamed prince. Everyone has a role to play in this dance. Even her.</span>", "<span class='warning>HOLY CRAP WHAT?!</span>")
			...
			if("Cegorach")
				spawn(0)
					if(istype(user.get_active_hand(), /obj/item/clothing/mask/gas/mime))
						user.visible_message("<span class='notice'>[user] draws on the mask with deep shades of bright red and yellow.</span>", "<span class='notice'>The Laughing God. The prankster. One day his biggest prank will be to save the universe. What a laugh that will be.</span>", "<span class='warning>HOLY CRAP WHAT?!</span>")
						qdel(user.get_active_hand())
						user.put_in_hands(new /obj/item/clothing/mask/gas/mime/cegorach (user))
					else if(istype(user.get_inactive_hand(), /obj/item/clothing/mask/gas/mime))
						user.visible_message("<span class='notice'>[user] draws on the mask with deep shades of bright red and yellow.</span>", "<span class='notice'>The Laughing God. The prankster. One day his biggest prank will be to save the universe. What a laugh that will be.</span>", "<span class='warning>HOLY CRAP WHAT?!</span>")
						qdel(user.get_inactive_hand())
						user.put_in_hands(new /obj/item/clothing/mask/gas/mime/cegorach(user))
			if("Death")
				spawn(0)
					if(istype(user.get_active_hand(), /obj/item/clothing/mask/gas/mime))
						user.visible_message("<span class='notice'>[user] draws on the mask with deep shades of black.</span>", "<span class='notice'>Death. You will find him in every sector. On every planet. In the eyes of every living creature.</span>", "<span class='warning>HOLY CRAP WHAT?!</span>")
						qdel(user.get_active_hand())
						user.put_in_hands(new /obj/item/clothing/mask/gas/mime/death(user))
					else if(istype(user.get_inactive_hand(), /obj/item/clothing/mask/gas/mime))
						user.visible_message("<span class='notice'>[user] draws on the mask with deep shades of black.</span>", "<span class='notice'>Death. You will find him in every sector. On every planet. In the eyes of every living creature.</span>", "<span class='warning>HOLY CRAP WHAT?!</span>")
						qdel(user.get_inactive_hand())
						user.put_in_hands(new /obj/item/clothing/mask/gas/mime/death(user))
			if("Blinded Princess")
				spawn(0)
					if(istype(user.get_active_hand(), /obj/item/clothing/mask/gas/mime))
						user.visible_message("<span class='notice'>[user] draws on the mask with deep shades of white and wraps it with a blindfold.</span>", "<span class='notice'>The Blinded Princess.</span>", "<span class='warning>HOLY CRAP WHAT?!</span>")
						qdel(user.get_active_hand())
						user.put_in_hands(new /obj/item/clothing/mask/gas/mime/blind(user))
					else if(istype(user.get_inactive_hand(), /obj/item/clothing/mask/gas/mime))
						user.visible_message("<span class='notice'>[user] draws on the mask with deep shades of white and wraps it with a blindfold.</span>", "<span class='notice'>The Blinded Princess.</span>", "<span class='warning>HOLY CRAP WHAT?!</span>")
						qdel(user.get_inactive_hand())
						user.put_in_hands(new /obj/item/clothing/mask/gas/mime/blind(user))
