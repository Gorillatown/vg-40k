		...
		if(job_civilian_high)//I hate how this looks, but there's no reason to go through this switch if it's empty
			...
			switch(job_engsec_high)
				...
				if(BASICORK) //SS40k EDIT
					...
					clothes_s.Blend(new /icon('F_40kshit/icons/mob/orks/orkgearMOB.dmi', "orkhelmet1"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('F_40kshit/icons/mob/orks/orkgearMOB.dmi', "orkboots1"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('F_40kshit/icons/mob/orks/orkgearMOB.dmi', "brownbackpack"), ICON_OVERLAY)
				if(LORD)
					clothes_s = new /icon(uniform_dmi, "lord_s")
					clothes_s.Blend(new /icon(feet_dmi, "lord"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('F_40kshit/icons/mob/lord_hat.dmi', "lord_hat"), ICON_OVERLAY)
...
//					clothes_s.Blend(new /icon(suit_dmi, "patrolman"), ICON_OVERLAY)
				if(PDFTROOPER)
					clothes_s = new /icon(uniform_dmi, "jg_patrolman_s")
					clothes_s.Blend(new /icon(feet_dmi, "patrolman_jg"), ICON_UNDERLAY) 
//					clothes_s.Blend(new /icon('icons/mob/head.dmi', "jg_red_bandana"), ICON_OVERLAY)
					clothes_s.Blend(new /icon(suit_dmi, "patrolman_jg"), ICON_OVERLAY)
				if(COMMISSAR)
				...
				if(ENGINSEER)
					...
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "mech_belt"), ICON_OVERLAY)
				if(SENESCHAL)
