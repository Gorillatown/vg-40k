...
/obj/item/weapon/propguitar	//basic guitar, playes sound.
	...
	inhand_states = list("left_hand" = 'F_40kshit/icons/inhands/LEFTIES/celebguitar_left.dmi', "right_hand" = 'F_40kshit/icons/inhands/RIGHTIES/celebguitar_right.dmi')
	icon = 'F_40kshit/icons/obj/objects.dmi'
	icon_state = "guitar1"
	item_state = "guitar1"
	force = 9
	var/playing = 0
...
/obj/item/weapon/propguitar/interact(mob/user)
	...
	if(playing)
		...
		playing = 1
		var/guitarsound = pick('F_40kshit/sounds/guitar1.ogg','F_40kshit/sounds/guitar2.ogg')
...
/obj/item/weapon/propguitar/two/attackby(obj/item/weapon/W, mob/user)//after screwdriver comes powercell
	...
	if(istype(W, /obj/item/weapon/cell))
		playsound(src.loc, 'F_40kshit/sounds/misc_effects/bin_open.ogg', 50, 1)
...
/obj/item/weapon/propguitar/five/interact(mob/user)
	...
	if(playing)
		...
		playing = 1
		var/guitarsound = pick('F_40kshit/sounds/guitar3.ogg','F_40kshit/sounds/guitar4.ogg') //'F_40kshit/sounds/guitar5.ogg' this ones raining blood//new sounds
