/obj/item/weapon/daemonweapon/blissrazor
	...
	icon = 'F_40kshit/icons/obj/64x64weapons.dmi'
	icon_state = "blissrazor_closed"
	inhand_states = list("left_hand" = 'F_40kshit/icons/inhands/LEFTIES/64x64blissrazor.dmi', "right_hand" = 'F_40kshit/icons/inhands/RIGHTIES/64x64blissrazor.dmi')
