...
/obj/item/weapon/gun/projectile/eviscerator
	...
	inhand_states = list("left_hand" = 'F_40kshit/icons/inhands/LEFTIES/64x64eviscerator.dmi', "right_hand" = 'F_40kshit/icons/inhands/RIGHTIES/64x64eviscerator.dmi')
	...
	hitsound = 'F_40kshit/sounds/chainsword_evishit.ogg'
	fire_sound = null
...
/obj/item/weapon/gun/projectile/eviscerator/process()
	...
	if(idle_loop >= 1)
		idle_loop = 0
		playsound(src,'F_40kshit/sounds/Chainsword_Idle.ogg',50)
		if(!firstrev)
			firstrev = TRUE
