/obj/item/weapon/inq_katana
	name = "Inquisitor's Katana"
	desc = "Folded over 10 times by probably a random non asian man in imperium space."
	inhand_states = list("left_hand" = 'F_40kshit/icons/inhands/LEFTIES/32x32axes_swords_left.dmi', "right_hand" = 'F_40kshit/icons/inhands/RIGHTIES/32x32axes_swords_right.dmi')
	icon = 'F_40kshit/icons/obj/weapons.dmi'
	icon_state = "inq_katana"
	item_state = "inq_katana"
...
/obj/item/weapon/inq_katana/New()
	..()

/obj/item/weapon/inq_katana/interpret_powerwords(mob/living/target, mob/living/user, def_zone, var/originator = null)
	..()
