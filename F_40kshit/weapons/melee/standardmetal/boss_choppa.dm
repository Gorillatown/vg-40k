/obj/item/weapon/boss_choppa
	...
	inhand_states = list("left_hand" = 'F_40kshit/icons/inhands/LEFTIES/64x64huge_choppa_left.dmi', "right_hand" = 'F_40kshit/icons/inhands/RIGHTIES/64x64huge_choppa_right.dmi')
	icon = 'F_40kshit/icons/obj/orks/32x64_ork_obj.dmi'
