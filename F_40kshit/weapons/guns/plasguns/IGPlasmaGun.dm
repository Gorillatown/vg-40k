...
/obj/item/weapon/gun/ig_plasma_gun
	...
	inhand_states = list("left_hand" = 'F_40kshit/icons/inhands/LEFTIES/64x64plasgun_left.dmi', "right_hand" = 'F_40kshit/icons/inhands/RIGHTIES/64x64plasgun_right.dmi')
...
/obj/item/projectile/plasma
	...
	custom_impact = 1
	linear_movement = 0
	fire_sound = 'F_40kshit/sounds/plasmagun.ogg'
...
/obj/item/projectile/plasma/OnFired()
	...
	if(plasgun.overcharged)
		icon = 'F_40kshit/icons/obj/64x64projectiles.dmi'
		damage = 140
		kill_count = 20
	else
		icon = 'F_40kshit/icons/obj/projectiles.dmi'
