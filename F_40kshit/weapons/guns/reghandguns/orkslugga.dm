/obj/item/weapon/gun/projectile/automatic/slugga
	...
	icon_state = "slugga"
	item_state = "slugga"
	inhand_states = list("left_hand" = 'F_40kshit/icons/inhands/LEFTIES/ork_guns_left.dmi', "right_hand" = 'F_40kshit/icons/inhands/RIGHTIES/ork_guns_right.dmi')
	...
	fire_sound = 'F_40kshit/sounds/slugga_1.ogg'
	load_method = 2
