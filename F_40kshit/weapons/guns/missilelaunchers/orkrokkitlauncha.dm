/obj/item/weapon/gun/projectile/rocketlauncher/rokkitlauncha
	...
	icon = 'F_40kshit/icons/obj/orks/orkequipment.dmi'
	icon_state = "rokkit_launcha"
	item_state = "rokkit_launcha"
	inhand_states = list("left_hand" = 'F_40kshit/icons/inhands/LEFTIES/64x64rokkit_launcha_left.dmi', "right_hand" = 'F_40kshit/icons/inhands/RIGHTIES/64x64rokkit_launcha_right.dmi')
	max_shells = 1
...
/obj/item/ammo_casing/rocket_rpg/rokkit
	...
	icon = 'F_40kshit/icons/obj/orks/orkbulletpilesandmags.dmi'
	icon_state = "rokkit"
	caliber = ORKROKKIT
