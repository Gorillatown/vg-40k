...
/spell/aoe_turf/waaagh1/cast(list/targets, mob/user)
	...
	*/
	...
	if(isgretchin(user))
		user.say("AaAaAaHH!")
		playsound(user, 'F_40kshit/sounds/gretscream3.ogg',100)
	else
		user.say("WAAAAGH!")
		playsound(user, 'F_40kshit/sounds/waagh1.ogg', 100)
...
/spell/aoe_turf/warbosswaaagh/cast(list/targets, mob/user)
	...
	user.say("WAAAAGH!")
	playsound(user, 'F_40kshit/sounds/warbosswaaagh.ogg', 100)
