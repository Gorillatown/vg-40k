...
/spell/targeted/projectile/shrieker_cannon/cast(list/targets, mob/living/user = usr)
	..()
	if(user.gender == MALE)
		var/mimelaugh = pick('F_40kshit/sounds/mimelaugh1.ogg','F_40kshit/sounds/mimelaugh2.ogg')
		playsound(user.loc, mimelaugh, 75, 0)
	else
		var/mimelaugh = pick('F_40kshit/sounds/mimelaughf1.ogg','F_40kshit/sounds/mimelaughf2.ogg')
		playsound(user.loc, mimelaugh, 75, 0)
